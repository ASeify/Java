...
public class Stemmer {
    ...
    private final boolean cvc(int i) {
        ...
        {
            int ch = b[i];
            if (Character.toLowerCase(ch) == 'w' || Character.toLowerCase(ch) == 'x' || Character.toLowerCase(ch) == 'y') {
                return false;
            }
        }
        return true;
    ...
    private final void step1() {
        if (Character.toLowerCase(b[k]) == 's') {
            if (ends("sses")) {
                k -= 2;
            } else if (ends("ies")) {
                setto("i");
            } else if (Character.toLowerCase(b[k - 1]) != 's') {
                k--;
            }
        }
        if (ends("eed")) {
            ...
            if (ends("at")) {
                ...
                {
                    int ch = b[k];
                    if (Character.toLowerCase(ch) == 'l' || Character.toLowerCase(ch) == 's' || Character.toLowerCase(ch) == 'z') {
                        k++;
                    }
                }
            } else if (m() == 1 && cvc(k)) {
...
//        }
    ...
    private final void step5() {
        ...
        /* for Bug 1 */ switch (b[k - 1]) {
            ...
            case 'n':
                ...
                return;
            case 'o':
                if (ends("ion") && j >= 0 && (Character.toLowerCase(b[j]) == 's' || Character.toLowerCase(b[j]) == 't')) {
                    break;
                }
                /* j >= 0 fixes Bug 2 */
                if (ends("ou")) {
    ...
    private final void step6() {
        j = k;
        if (Character.toLowerCase(b[k]) == 'e') {
            int a = m();
            if (a > 1 || a == 1 && !cvc(k - 1)) {
                k--;
            }
        }
        if (Character.toLowerCase(b[k]) == 'l' && doublec(k) && m() > 1) {
            k--;
        }
    }
